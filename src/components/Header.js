              ...
              <div className="navbar-menu">
                <div className="navbar-left">
                  <div className="navbar-item has-dropdown">
                    <Link to="https://www.inflearn.com/courses">
                      <span>강의</span>
                    </Link>
                  </div>
                  ...
                  <div className="navbar-item">
                    <Link to="https://www.inflearn.com/mentors">
                      <span>멘토링</span>
                    </Link>
                  </div>

                  <div className="navbar-item has-dropdown">
                    <Link to="https://www.inflearn.com/community/questions">
                      <span>커뮤니티</span>
                    </Link>
                  </div>

                  <div className="navbar-item has-dropdown">
                    <Link to="https://www.inflearn.com/inflearn">
                      <span>인프런</span>
                    </Link>
                  </div>
                </div>
                <div className="navbar-right">
                  ...
                  <div className="navbar-item">
                    <Link to="https://www.inflearn.com/open-knowledge">
                      <span>지식공유참여</span>
                    </Link>
                  </div>
                  ...
                  <div className="navbar-item" id="cart">
                    <span className="cart has-dropdown">
                      <Link to="https://www.inflearn.com/carts">
                        <span className="icon">
                  ...
                  <div className="navbar-item" id="message">
                    <span className="message has-dropdown">
                      <Link to="https://www.inflearn.com/messages">
                        <span className="icon">
                          <i className="far fa-bell"></i>
                        </span>
                      </Link>
                      <span className="new-message-mark"></span>
                    </span>
                  </div>

                  <div className="navbar-item" id="profile">
                    <span className="profile has-dropdown">
                      <Link to="/signup">
                        <img
