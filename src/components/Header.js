              ...
              <div class="navbar-menu">
                <div class="navbar-left">
                  <div class="navbar-item has-dropdown">
                    <a href="https://www.inflearn.com/courses">
                      <span>강의</span>
                    </a>
                  </div>
                  ...
                  <div class="navbar-item">
                    <a href="https://www.inflearn.com/mentors">
                      <span>멘토링</span>
                    </a>
                  </div>
                  ...
                  <div class="navbar-item has-dropdown">
                    <a href="https://www.inflearn.com/inflearn">
                      <span>인프런</span>
                    </a>
                  </div>
                </div>
                <div class="navbar-right">
                  ...
                  <div class="navbar-item">
                    <a href="https://www.inflearn.com/open-knowledge">
                      <span>지식공유참여</span>
                    </a>
                  </div>

                  <div class="navbar-item" id="recent-lecture">
                    <a href="#" class="btn">
                  ...
                  <div class="navbar-item" id="cart">
                    <span class="cart has-dropdown">
                      <a href="https://www.inflearn.com/carts">
                        <span class="icon">
                  ...
                  <div class="navbar-item" id="message">
                    <span class="message has-dropdown">
                      <a href="https://www.inflearn.com/messages">
                        <span class="icon">
                  ...
                  <div class="navbar-item" id="profile">
                    <span class="profile has-dropdown">
                      <a href="https://www.inflearn.com/dashboard">
                        <img
