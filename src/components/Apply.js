  ...
  return (
    <div>
      <section class="apply">
        <div class="container">
          <div class="header">
            <h2 class="title">다양한 서비스를 신청하세요.</h2>
          ...
          <div class="apply-container">
            <div class="apply-wrapper">
              ...
              <div class="box">
                <h3 class="box-title">인프런 비즈니스 신청</h3>
                <div class="box-detail">
              ...
              <div class="box">
                <h3 class="box-title">인프런 X 대학생</h3>
                <div class="box-detail">
                  학교와 인프런이 함께 하여,
                  <br />
