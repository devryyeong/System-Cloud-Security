    ...
    <div>
      ...
      <div class="wrapper">
        <div class="footer-top">
          <div class="menu-list">
            <div class="menu-title">인프런</div>
            <div class="menu-items">
              <a href="#" class="menu-item">공지사항</a>
              <a href="#" class="menu-item">인프런 소개</a>
              <a href="#" class="menu-item">인프랩 실Log</a>
              <a href="#" class="menu-item">채용 안내</a>
            </div>
          </div>
          <div class="menu-list">
            <div class="menu-title">고객센터</div>
            <div class="menu-items">
              <a href="#" class="menu-item">자주묻는 질문</a>
              <a href="#" class="menu-item">수료증 확인</a>
              <a href="#" class="menu-item">이용약관</a>
              <a href="#" class="menu-item">개인정보취급방침</a>
            </div>
          </div>
          <div class="menu-list">
            <div class="menu-title">신청하기</div>
            <div class="menu-items">
              <a href="#" class="menu-item">지식공유참여</a>
              <a href="#" class="menu-item">인프런 비즈니스</a>
              <a href="#" class="menu-item">인프런 X 대학교</a>
              <a href="#" class="menu-item">인프런 X AWS 제휴</a>
            </div>
          </div>
          <div class="menu-list">
            <div class="menu-title">학습하기</div>
            <div class="menu-items">
              <a href="#" class="menu-item">IT 프로그래밍</a>
              <a href="#" class="menu-item">크리에이티브</a>
              <a href="#" class="menu-item">업무스킬</a>
              <a href="#" class="menu-item">수강코드 등록</a>
            </div>
          </div>
          <div class="menu-list">
            <div class="menu-title">커뮤니티</div>
            <div class="menu-items">
              <a href="#" class="menu-item">학습로드맵</a>
              <a href="#" class="menu-item">질문 & 답변</a>
              <a href="#" class="menu-item">수강평 모아보기</a>
              <a href="#" class="menu-item">강의 · 기능요청</a>
            </div>
          </div>
        </div>
        <div class="footer-bottom">
          ...
          <div class="footer-bottom-right">
            ...
            <a href="#" id="naver-blog">
              B
            </a>
            <a href="#" id="instagram">
              I
            </a>
            <a href="#" id="youtube">Y</a>
