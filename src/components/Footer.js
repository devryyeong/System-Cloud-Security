      ...
      <div className="wrapper">
        <div className="footer-top">
          <div className="menu-list">
            <div className="menu-title">인프런</div>
            <div className="menu-items">
              <Link to="/" className="menu-item">공지사항</Link>
              <Link to="/" className="menu-item">인프런 소개</Link>
              <Link to="/" className="menu-item">인프랩 실Log</Link>
              <Link to="/" className="menu-item">채용 안내</Link>
            </div>
          </div>
          <div className="menu-list">
            <div className="menu-title">고객센터</div>
            <div className="menu-items">
              <Link to="/" className="menu-item">자주묻는 질문</Link>
              <Link to="/" className="menu-item">수료증 확인</Link>
              <Link to="/" className="menu-item">이용약관</Link>
              <Link to="/" className="menu-item">개인정보취급방침</Link>
            </div>
          </div>
          <div className="menu-list">
            <div className="menu-title">신청하기</div>
            <div className="menu-items">
              <Link to="/" className="menu-item">지식공유참여</Link>
              <Link to="/" className="menu-item">인프런 비즈니스</Link>
              <Link to="/" className="menu-item">인프런 X 대학교</Link>
              <Link to="/" className="menu-item">인프런 X AWS 제휴</Link>
            </div>
          </div>
          <div className="menu-list">
            <div className="menu-title">학습하기</div>
            <div className="menu-items">
              <Link to="/" className="menu-item">IT 프로그래밍</Link>
              <Link to="/" className="menu-item">크리에이티브</Link>
              <Link to="/" className="menu-item">업무스킬</Link>
              <Link to="/" className="menu-item">수강코드 등록</Link>
            </div>
          </div>
          <div className="menu-list">
            <div className="menu-title">커뮤니티</div>
            <div className="menu-items">
              <Link to="/" className="menu-item">학습로드맵</Link>
              <Link to="/" className="menu-item">질문 & 답변</Link>
              <Link to="/" className="menu-item">수강평 모아보기</Link>
              <Link to="/" className="menu-item">강의 · 기능요청</Link>
            </div>
          </div>
        </div>
        <div className="footer-bottom">
          <div className="footer-bottom-left">
            ...
            <div className="footer-info-bottom">
              <div className="info-dropdown">
                ...
                <span>
                  사업자번호: 499-81-00612 
                  <Link to="http://www.ftc.go.kr/bizCommPop.do?wrkr_no=4998100612" target="_blank">사업자 정보 확인</Link>
                </span>
                <br />
          ...
          <div className="footer-bottom-right">
            ...
            <Link to="/" id="naver-blog">
              B
            </Link>
            <Link to="/" id="instagram">
              I
            </Link>
            <Link to="/" id="youtube">Y</Link>
            <Link to="/" id="facebook">F</Link>
          </div>
        </div>
      </div>
    </footer>
